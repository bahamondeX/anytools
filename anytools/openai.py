...
try:
    ...
    print(
        "Please install the OpenAI library first to use it as tool orchestrator: `pip install openai`"
    )
    sys.exit(0)
################################################################
...
class OpenAIAgent(OpenAITool):
    ...
    Attributes:
        model (openaiModels): The language model to be used for chat completion.
            Defaults to "gpt-4o".
    ...
    model: openaiModels = Field(default="gpt-4o")
